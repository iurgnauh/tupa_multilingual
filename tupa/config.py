...
def add_param_arguments(ap=None, arg_default=None):  # arguments with possible format-specific parameter values
    ...
    add(group, "--word-dim-external", type=int, default=512, help="dimension for external word embeddings")
    ...
    add_boolean(group, "update-word-vectors", "external word vectors in training parameters", default=False)
...
class Config(object, metaclass=Singleton):
    def __init__(self, *args):
        ...
        ap.add_argument("passages", type=str, help="passage files/directories to test on/parse")
        ...
        ap.add_argument("--all_langs", nargs='+', default=())
